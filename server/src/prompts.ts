...
export function scanSystemPrompt(settings: Settings, hasImage = true): string {
  ...
  return (
    ...
    `\n• "recommendedTrades" (upgrades / hot names) = SPECIFIC, REAL cards of players who are a step up or an equally hot name worth chasing. "similarValueTargets" (fair swaps) = SPECIFIC, REAL cards of comparable-caliber players you could reasonably get in a 1-for-1, judged on player quality and demand, not on a price match.` +
