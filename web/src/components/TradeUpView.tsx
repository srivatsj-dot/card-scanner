...
export default function TradeUpView({ settings, saved }: { settings: Settings; saved: SavedCard[] }) {
  const t = useT();
    ...
    <div>
      ...
      {result && (
        <div className="card">
          ...
          {result.feasible && <p style={{ marginTop: 0, fontWeight: 600 }}>{result.summary}</p>}
